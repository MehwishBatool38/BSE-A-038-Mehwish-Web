...
│   ├── ef_plans           # Fee plans
│   ├── ef_assignments     # Fee plan assignments
│   ├── ef_payments        # Payment records
│   ├── ef_notifications   # System notifications
│   └── ef_counter         # ID counters
🔐 Authentication
...
Open fee-management-system.html in any modern browser
